...
#define pwm_pin pwm_4
#define dir_pin dir_4
...
void setup() {
  ...
  Serial.begin(115200);
  delay(10000);
  Serial.print("EXPERIMENTO MIN-MAX RUEDA 2, CON DIRECCION: ");
  #if ADELANTE
